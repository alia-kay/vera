...
const SendArrow = () => html`
  <svg width="16" height="16" viewBox="0 0 32 32" fill="none">
    <line x1="16" y1="26" x2="16" y2="6" stroke="#101820" strokeWidth="2" strokeLinecap="square"/>
    <line x1="16" y1="6" x2="8" y2="14" stroke="#101820" strokeWidth="2" strokeLinecap="square"/>
    <line x1="16" y1="6" x2="24" y2="14" stroke="#101820" strokeWidth="2" strokeLinecap="square"/>
  </svg>
`
        ...
        ${NAV_TABS.map(({ id, label, Icon }) => {
          ...
          return html`
            <button key=${id} className=${cls} onClick=${() => onTabChange && onTabChange(id)}>
              <${Icon} color=${color} />
              <span className="share-nav-label">${label}</span>
            </button>
          `
        })}
      </nav>
